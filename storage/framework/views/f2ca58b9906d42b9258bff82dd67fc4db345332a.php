<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
      <img src="../assets/foto/kg/logo.png" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('kelas.*') ? 'active' : ''); ?> " href="<?php echo e(route('kelas.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('kontenVidio.*') ? 'active' : ''); ?> " href="<?php echo e(route('kontenVidio.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Konten Vidio</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('kontenDokumen.*') ? 'active' : ''); ?> " href="<?php echo e(route('kontenDokumen.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Konten Dokumen</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('iklan.*') ? 'active' : ''); ?> " href="<?php echo e(route('iklan.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('artikel.*') ? 'active' : ''); ?> " href="<?php echo e(route('artikel.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo e(Route::is('profil.*') ? 'active' : ''); ?> " href="<?php echo e(route('profil.index')); ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<?php /**PATH D:\xampp\htdocs\Web-Admin\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>